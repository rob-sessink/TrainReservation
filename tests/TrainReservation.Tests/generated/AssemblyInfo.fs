...
[<assembly: AssemblyTitleAttribute("TrainReservation.Tests")>]
[<assembly: AssemblyProductAttribute("TrainReservation")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "TrainReservation.Tests"
    let [<Literal>] AssemblyProduct = "TrainReservation"
