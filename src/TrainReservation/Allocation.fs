module TrainReservation.Allocation
...
let capacityStrategy: CapacityStrategy =
    fun request trainInformation ->
        ...
        let allocationSettings = provideReservationSettings trainInformation

        let trainCapacity = calculateTrainCapacity allocationSettings trainInformation
...
let allocateSeats: AllocateSeats =
    fun request trainInformation ->
        ...
        let availability = capacityStrategy request trainInformation
